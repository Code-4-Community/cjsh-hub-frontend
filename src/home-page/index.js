    ...
    return (
        <>
                ...
                <div className="float-end">
                    <ul className="nav nav-pills mb-2 text-white">
                        ...
                        <li className="nav-item">
                            ...
                            <Button className="nav-link text-primary fw-normal" onClick={onOpen}>Log
                                In</Button>

                            <Modal isOpen={isOpen} onClose={onClose}>
                                <ModalOverlay/>
                                <ModalContent>
                                    <ModalHeader><b>Log In</b></ModalHeader>
                                    <ModalCloseButton/>
                                    <ModalBody>
                                        <div className="m-2">
                        ...
                        <li className="nav-item">
                            ...
                            <Modal isOpen={isOpen} onClose={onClose}>
                                <ModalOverlay/>
                                <ModalContent>
                                    <ModalHeader><b>Sign Up</b></ModalHeader>
                                    <ModalCloseButton/>
                                    <ModalBody>
                                        <div className="m-2">
            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img className="d-block w-100 image-height-400"
                             src={require("../images/tree.jpg")} alt="First slide"/>
                    </div>
            ...
            <div className="row m-5 background-teal">
                ...
                <div className="col-4">
                    <img className="image-height-300 float-end"
